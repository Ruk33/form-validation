...
b[e])||(d&&(b[e].message&&d.append("<div>"+b[e].message+"</div>"),d.show()),c=!1);return c},validateAllInputs:function(a){var b=!0,c;for(c in a)__formValidation.validate(c,a[c])||(b=!1);return b}},addCustomFormValidation=function(a,b){__formValidation.validations[a]=function(a,d){return b(a,d)}};
